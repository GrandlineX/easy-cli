...
describe('Parser', () => {
  test.each([
    ...
    [
      'Full param list',
      'first second --boolT=true --boolF=false --num1=1 --num2=1.1 --without',
      true,
    ],
    [
      'Long URL',
      'download --url=https://www.demo.tv/videos/12345?filter=archives&sort=time',
      true,
    ],
    [
      'Long bad URL ',
    ...
    try {
      const parser = new CliParser(logger, args.split(' '));
